...
namespace office360.Areas.ACompany.Controllers
{
    public class CCompanyManagmentUIController : Controller
    {
        ...
        [UsersSessionCheck]
        [CompanySessionCheck]
        public ActionResult CreateUpdate_CMUI_Company(_SqlParameters PostedData)
        {
            #region PASS VIEW
        ...
        [HttpPost]
        public ActionResult UpSert_Into_CM_Company(_SqlParameters PostedData)
        {
        ...
        public ActionResult GET_MT_CM_COMPANY_BYPARAMETER_SEARCH(_SqlParameters PostedData)
        {
        ...
        public ActionResult GET_MT_CM_COMPANY_INFOBYGUID(_SqlParameters PostedData)
        {
