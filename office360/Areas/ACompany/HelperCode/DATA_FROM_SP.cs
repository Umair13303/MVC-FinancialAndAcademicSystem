...
namespace office360.Areas.ACompany.HelperCode
{
    public class DATA_FROM_SP
    {
        ...
        public static List<CM_Company_GetListByParam_Result> GET_MT_CM_Company_By_Param_List(SQLParamters PostedData)
        {
        ...
        public static List<RSM_RightSetting_GetListByParam_Result> GET_MT_RSM_RightSetting_By_Param_List(SQLParamters PostedData)
        {
