...
namespace office360.Areas.AAccount.Controllers
{
    public class CAccountDiscountTypeManagmentUIController : Controller
    {
        ...
        public JsonResult UpSert_Into_ADTM_DiscountType(SQLParamters PostedData)
        {
        ...
        public JsonResult GET_MT_ADTM_DISCOUNTTYPE_BYPARAMETER_SEARCH(SQLParamters PostedData)
        {
        ...
        public JsonResult GET_MT_ADTM_DISCOUNTTYPE_INFOBYGUID(SQLParamters PostedData)
        {
        ...
        public JsonResult GET_MT_ACOAM_CHARTOFACCOUNT_LIST_BY_SEARCHQUERY_FORDATATABLE(SQLParamters PostedData)
        {
