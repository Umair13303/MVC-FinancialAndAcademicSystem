...
namespace office360.Areas.AAccount.Controllers
{
    public class CAccountClassFeeStructureManagmentUIController : Controller
    {
        ...
        public ActionResult GET_MT_AFTM_FEETYPE_BYPARAMTER(SQLParamters PostedData)
        {
            ...
            {
                case nameof(DB_OperationType.INSERT_DATA_INTO_DB):
                    PostedData.DB_IF_PARAM = nameof(MDBDataFilter.AFTM_FEETYPE_BY_COMPANYID_FORNEWINSERT);
                    break;
                default:
                    PostedData.DB_IF_PARAM = nameof(MDBDataFilter.AFTM_FEETYPE_BY_COMPANYID_FORUPDATERECORD);
                    break;
            }
