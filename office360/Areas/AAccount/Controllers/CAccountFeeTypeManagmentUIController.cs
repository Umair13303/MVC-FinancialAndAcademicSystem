...
namespace office360.Areas.AAccount.Controllers
{
    public class CAccountFeeTypeManagmentUIController : Controller
    {
        ...
        public JsonResult GET_MT_AFTM_FEETYPE_BYPARAMETER_SEARCH(SQLParamters PostedData)
        {
        ...
        {
            PostedData.DB_IF_PARAM = nameof(MDBDocFilter.AFTM_FEETYPE_BY_COMPANYID_SEARCH_PARAMETER_UPDATEFEETYPE);
        ...
        public JsonResult GET_MT_AFTM_FEETYPE_LIST_BY_SEARCHQUERY_FORDATATABLE(SQLParamters PostedData)
        {
