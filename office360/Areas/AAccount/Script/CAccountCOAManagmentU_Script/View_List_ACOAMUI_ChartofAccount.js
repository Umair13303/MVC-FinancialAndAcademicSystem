...
function InitDataTable() {
    table = $('#MainTableACOAM_ChartofAccount').DataTable({
        ...
        "columns": [
            ...
            { "data": "AccountCatagory", "title": "Catagory" },
            {
...
function DrawDataTable() {
    ...
    table.ajax.url((BasePath + "/AAccount/CAccountCOAManagmentUI/GET_MT_ACOAM_CHARTOFACCOUNT_LIST_BY_SEARCHQUERY_FORDATATABLE?" + queryString)).load();
}