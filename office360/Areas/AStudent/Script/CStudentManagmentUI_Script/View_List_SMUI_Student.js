...
function InitDataTable() {
    var ParentGroupColumn = 3;
    table = $('#MainTableSM_Student').DataTable({
        ...
        "columns": [
            ...
            { "data": "AdmissionSession", "title": "AdmissionSession" },
            { "data": "Code", "title": "Code" },
            { "data": "RegistrationNumber", "title": "Registration Number" },
            { "data": "StudentName", "title": "Student Name" },
            { "data": "StudentCNIC", "title": "Student CNIC" },
            { "data": "FatherName", "title": "Father Name" },
            { "data": "FatherCNIC", "title": "Father CNIC" },
            { "data": "StudentMobile", "title": "Mobile" },
        ...
        drawCallback: function (settings) {
            DataTableGroupBy_Column_Detail(this, 'MainTableSM_Student', ['Class', 'AdmissionSession']);
        }
    });
...
function DrawDataTable() {
    ...
    table.ajax.url((BasePath + "/AStudent/CStudentManagmentUI/GET_MT_SM_STUDENT_LIST_BY_SEARCHQUERY_FORDATATABLE?" + queryString)).load();
}