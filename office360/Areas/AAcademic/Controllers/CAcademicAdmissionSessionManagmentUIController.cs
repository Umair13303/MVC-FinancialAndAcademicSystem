...
namespace office360.Areas.AAcademic.Controllers
{
    public class CAcademicAdmissionSessionManagmentUIController : Controller
    {
        ...
        [UsersSessionCheck]
        [CompanySessionCheck]
        public ActionResult CreateUpdate_AASMUI_AdmissionSession(SQLParamters PostedData)
        {
            #region PASS VIEW
        ...
        [UsersSessionCheck]
        [CompanySessionCheck]
        public ActionResult View_List_AASMUI_AdmissionSession(SQLParamters PostedData)
        {
            #region PASS VIEW
            _Exe = GetAllListFromDB.GetAllowedUsersRightsByParameter(PostedData.RightId);
            #endregion
        ...
        public JsonResult GET_LK1_ACADEMICYEAR(SQLParamters PostedData)
        {
        ...
        public JsonResult GET_MT_AASM_ADMISSIONSESSION_BYPARAMETER_SEARCH(SQLParamters PostedData)
        {
            PostedData.DB_IF_PARAM = nameof(MDBDocFilter.AASM_ADMISSIONSESSION_BY_ALLOWEDBRANCHIDS_SEARCH_PARAMETER_UPDATEADMISSIONSESSION);
        ...
        public JsonResult GET_MT_AASM_ADMISSIONSESSION_INFOBYGUID(SQLParamters PostedData)
        {
        ...
        public JsonResult GET_MT_AASM_ADMISSIONSESSION_LIST_BY_SEARCHQUERY_FORDATATABLE(SQLParamters PostedData)
        {
