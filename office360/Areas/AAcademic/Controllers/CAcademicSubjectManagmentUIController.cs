...
namespace office360.Areas.AAcademic.Controllers
{
    public class CAcademicSubjectManagmentUIController : Controller
    {
        ...
        [UsersSessionCheck]
        [CompanySessionCheck]
        public ActionResult CreateUpdate_ASMUI_Subject(_SqlParameters PostedData)
        {
            #region PASS VIEW
        ...
        [UsersSessionCheck]
        [CompanySessionCheck]
        public ActionResult View_List_ASMUI_Subject(_SqlParameters PostedData)
        {
            #region PASS VIEW
            _Exe = GetAllListFromDB.GetAllowedUsersRightsByParameter(PostedData.RightId);
            #endregion
        ...
        public ActionResult GET_MT_ASM_SUBJECT_BYPARAMETER_SEARCH(_SqlParameters PostedData)
        {
        ...
        public ActionResult GET_MT_ASM_SUBJECT_INFOBYGUID(_SqlParameters PostedData)
        {
        ...
        public ActionResult GET_MT_ASM_SUBJECT_LIST_BY_SEARCHQUERY_FORDATATABLE(_SqlParameters PostedData)
        {
