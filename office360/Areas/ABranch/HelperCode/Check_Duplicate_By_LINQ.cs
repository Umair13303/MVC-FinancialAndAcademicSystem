...
namespace office360.Areas.ABranch.HelperCode
{
    ...
    {
        #region HELPER FOR :: CHECK IF BranchSetting(ACTIVE_BRANCH_SETTING) ALREADY EXIST FOR CLASS 
        public static int? IS_EXIST_BM_BRANCHSETTING_BYBRANCHID(_SqlParameters PostedData)
        {
