/*----------------------------------** GLOBAL VARIABLE FOR PAGE :: TABLE GENERAL BRANCH **-----------------------------------------------*/
...
function InitDataTable() {
    table = $('#MainTableGeneralBranch').DataTable({
...
function PopulateDropDownLists() {
    PopulateDTGroupByList('MainTableGeneralBranch', Css_Class.DynamicGroupBy, 'DropDownListGroupBy');
}
...
function DrawDataTable() {
    ...
    table.ajax.url((BasePath + "/ACompany/MBranchUI/GET_MT_GENERALBRANCH_LIST_BY_SEARCHQUERY_FORDATATABLE?" + queryString)).load();
}
