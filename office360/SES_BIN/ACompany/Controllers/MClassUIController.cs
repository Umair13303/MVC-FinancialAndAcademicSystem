...
namespace office360.Areas.ACompany.Controllers
{
    public class MClassUIController : Controller
    {
        ...
        [UsersSessionCheck]
        [CompanySessionCheck]
        public ActionResult CreateUpdateAppClass(_SqlParameters PostedData)
        {
            #region PASS VIEW
        ...
        #region ACTION RESULT FOR :: INSERT/UPDATE/DELETE INTO DBO_APPCLASS
        [HttpPost]
        public ActionResult UpSert_Into_AppClass(_SqlParameters PostedData)
        {
            _Exe = DB_Helper.MClassUI_Helper.CUD_Operation.Update_Insert_AppClass(PostedData);
        ...
        public ActionResult GET_MT_APPCLASS_BYPARAMETER_SEARCH(_SqlParameters PostedData)
        {
        ...
        #region ACTION RESULT FOR :: GET DOCUMENT DETAIL (DBO.APP_CLASS) -- LINQ-QUERY
        public ActionResult GET_MT_APPCLASS_INFOBYGUID(_SqlParameters PostedData)
        {
            var DATA = DB_Helper.MClassUI_Helper.Document_Detail_By_GUID_LINQ.GET_MT_APPCLASS_INFO_BY_GUID(PostedData).ToList();
            return Json(DATA, JsonRequestBehavior.AllowGet);
        }
