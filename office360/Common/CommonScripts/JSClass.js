...
class LK_LIST_CONDITION {
    static CHALLANMETHOD_LIST = "CHALLANMETHOD_LIST";
    static CHALLANMETHOD_LIST_BY_ID = "CHALLANMETHOD_LIST_BY_ID";
    static STUDYLEVEL_LIST = "STUDYLEVEL_LIST";
    static STUDYGROUP_LIST = "STUDYGROUP_LIST";
    static STUDYGROUP_BY_BRANCHSETTING = "STUDYGROUP_BY_BRANCHSETTING";
    static STUDYLEVEL_BY_BRANCHSETTING = "STUDYLEVEL_BY_BRANCHSETTING";
...
class DOCUMENT_LIST_CONDITION {
    ...
    static UM_USER_BY_COMPANYID_SEARCH_PARAMETER_UPDATEUSER = "UM_USER_BY_COMPANYID_SEARCH_PARAMETER_UPDATEUSER";
    ...
    static APPCLASS_BY_ALLOWEDBRANCHIDS_SEARCH_PARAMETER_UPDATECLASS = "APPCLASS_BY_ALLOWEDBRANCHIDS_SEARCH_PARAMETER_UPDATECLASS";
    static APPSESSION_BY_ALLOWEDBRANCHIDS_SEARCH_PARAMETER_UPDATESESSION = "APPSESSION_BY_ALLOWEDBRANCHIDS_SEARCH_PARAMETER_UPDATESESSION";
}