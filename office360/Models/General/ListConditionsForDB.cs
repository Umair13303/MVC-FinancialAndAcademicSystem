...
namespace office360.Models.General
{
    public class DBListCondition
    {
        ...
        public enum DB_SubOperationType
        {
            ENRSTUDENT_NEWADMISSION_INSERT,
            ENRSTUDENT_NEWADMISSION_INSERT_GENERATECHALLAN,
            ENRSTUDENT_NEWADMISSION_INSERT_EXCELUPLOAD,
            ENRSTUDENT_NEWADMISSION_INSERT_EXCELUPLOAD_GENERATECHALLAN,
        }
    }
}