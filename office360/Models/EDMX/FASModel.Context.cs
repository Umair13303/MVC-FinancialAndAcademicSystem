...
namespace office360.Models.EDMX
{
    ...
    public partial class FASEntities : DbContext
    {
        ...
        public virtual DbSet<ACFSM_ClassFeeStructure> ACFSM_ClassFeeStructure { get; set; }
        public virtual DbSet<ACFSM_ClassFeeStructureFeeType> ACFSM_ClassFeeStructureFeeType { get; set; }
        ...
        public virtual DbSet<StudyScheme> StudyScheme { get; set; }
        ...
        public virtual int AASM_AdmissionSession_Upsert(string dB_OperationType, Nullable<System.Guid> guID, Nullable<int> campusId, string description, Nullable<int> academicYearId, Nullable<System.DateTime> admissionStartDate, Nullable<System.DateTime> admissionEndDate, Nullable<System.DateTime> createdOn, Nullable<int> createdBy, Nullable<System.DateTime> updatedOn, Nullable<int> updatedBy, Nullable<int> docType, Nullable<int> documentStatus, Nullable<bool> status, Nullable<int> branchId, Nullable<int> companyId, string remarks, ObjectParameter response)
        {
            ...
            var admissionStartDateParameter = admissionStartDate.HasValue ?
                ...
                new ObjectParameter("AdmissionStartDate", typeof(System.DateTime));
        ...
        public virtual int ACFSM_ClassFeeStructure_Upsert(string dB_OperationType, Nullable<System.Guid> guID, Nullable<int> campusId, string description, Nullable<int> challanMethodId, Nullable<int> wHTaxPolicyId, Nullable<int> admissionSessionId, Nullable<int> classId, Nullable<System.DateTime> createdOn, Nullable<int> createdBy, Nullable<System.DateTime> updatedOn, Nullable<int> updatedBy, Nullable<int> docType, Nullable<int> documentStatus, Nullable<bool> status, Nullable<int> branchId, Nullable<int> companyId, string remarks, ObjectParameter response)
        {
            ...
            var wHTaxPolicyIdParameter = wHTaxPolicyId.HasValue ?
                new ObjectParameter("WHTaxPolicyId", wHTaxPolicyId) :
                new ObjectParameter("WHTaxPolicyId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ACFSM_ClassFeeStructure_Upsert", dB_OperationTypeParameter, guIDParameter, campusIdParameter, descriptionParameter, challanMethodIdParameter, wHTaxPolicyIdParameter, admissionSessionIdParameter, classIdParameter, createdOnParameter, createdByParameter, updatedOnParameter, updatedByParameter, docTypeParameter, documentStatusParameter, statusParameter, branchIdParameter, companyIdParameter, remarksParameter, response);
        }
        ...
        public virtual int ACOAM_ChartOfAccount_Upsert(string dB_OperationType, Nullable<System.Guid> guID, string description, Nullable<int> accountTypeId, Nullable<int> accountCategoryId, Nullable<int> financialStatementId, Nullable<System.DateTime> createdOn, Nullable<int> createdBy, Nullable<System.DateTime> updatedOn, Nullable<int> updatedBy, Nullable<int> docType, Nullable<int> documentStatus, Nullable<bool> status, Nullable<int> branchId, Nullable<int> companyId, string remarks, ObjectParameter response)
        {
            ...
            var financialStatementIdParameter = financialStatementId.HasValue ?
                new ObjectParameter("FinancialStatementId", financialStatementId) :
                new ObjectParameter("FinancialStatementId", typeof(int));
        ...
        public virtual ObjectResult<ADTM_DiscountType_GetListBySearch_Result> ADTM_DiscountType_GetListBySearch(Nullable<int> companyId, Nullable<int> branchId, Nullable<int> inputTypeId, string inputText)
        {
            var companyIdParameter = companyId.HasValue ?
                new ObjectParameter("CompanyId", companyId) :
                new ObjectParameter("CompanyId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ADTM_DiscountType_GetListBySearch_Result>("ADTM_DiscountType_GetListBySearch", companyIdParameter, branchIdParameter, inputTypeIdParameter, inputTextParameter);
        }
        ...
        public virtual ObjectResult<AFTM_FeeType_GetListBySearch_Result> AFTM_FeeType_GetListBySearch(Nullable<int> companyId, Nullable<int> branchId, Nullable<int> inputTypeId, string inputText)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<AFTM_FeeType_GetListBySearch_Result>("AFTM_FeeType_GetListBySearch", companyIdParameter, branchIdParameter, inputTypeIdParameter, inputTextParameter);
        }
    
        public virtual int AFTM_FeeType_Upsert(string dB_OperationType, Nullable<System.Guid> guID, string description, Nullable<int> feeCategoryId, Nullable<int> chargingMethodId, Nullable<bool> isOnAdmission, Nullable<bool> isSecurity, Nullable<bool> isRefundable, Nullable<bool> isDiscount, Nullable<int> revenueAccountId, Nullable<int> assetAccountId, Nullable<int> liabilityAccountId, Nullable<int> costOfSaleAccountId, Nullable<System.DateTime> createdOn, Nullable<int> createdBy, Nullable<System.DateTime> updatedOn, Nullable<int> updatedBy, Nullable<int> docType, Nullable<int> documentStatus, Nullable<bool> status, Nullable<int> branchId, Nullable<int> companyId, string remarks, ObjectParameter response)
        {
            var dB_OperationTypeParameter = dB_OperationType != null ?
                new ObjectParameter("DB_OperationType", dB_OperationType) :
                new ObjectParameter("DB_OperationType", typeof(string));
            ...
            var feeCategoryIdParameter = feeCategoryId.HasValue ?
                new ObjectParameter("FeeCategoryId", feeCategoryId) :
                new ObjectParameter("FeeCategoryId", typeof(int));
        ...
        public virtual int AQM_Question_Upsert(string dB_OperationType, Nullable<System.Guid> guID, Nullable<int> campusId, Nullable<int> classId, Nullable<int> subjectId, Nullable<int> questionTypeId, Nullable<int> optionLimit, string chapter, string description, Nullable<int> difficultyLevelId, string correctAnswer, string options, Nullable<System.DateTime> createdOn, Nullable<int> createdBy, Nullable<System.DateTime> updatedOn, Nullable<int> updatedBy, Nullable<int> docType, Nullable<int> documentStatus, Nullable<bool> status, Nullable<int> branchId, Nullable<int> companyId, string remarks, ObjectParameter response)
        {
            var dB_OperationTypeParameter = dB_OperationType != null ?
                new ObjectParameter("DB_OperationType", dB_OperationType) :
                new ObjectParameter("DB_OperationType", typeof(string));
            ...
            var optionLimitParameter = optionLimit.HasValue ?
                new ObjectParameter("OptionLimit", optionLimit) :
                new ObjectParameter("OptionLimit", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AQM_Question_Upsert", dB_OperationTypeParameter, guIDParameter, campusIdParameter, classIdParameter, subjectIdParameter, questionTypeIdParameter, optionLimitParameter, chapterParameter, descriptionParameter, difficultyLevelIdParameter, correctAnswerParameter, optionsParameter, createdOnParameter, createdByParameter, updatedOnParameter, updatedByParameter, docTypeParameter, documentStatusParameter, statusParameter, branchIdParameter, companyIdParameter, remarksParameter, response);
        }
        ...
        public virtual ObjectResult<ASM_Subject_GetListBySearch_Result> ASM_Subject_GetListBySearch(Nullable<int> companyId, Nullable<int> branchId, Nullable<int> inputTypeId, string inputText)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ASM_Subject_GetListBySearch_Result>("ASM_Subject_GetListBySearch", companyIdParameter, branchIdParameter, inputTypeIdParameter, inputTextParameter);
        }
    
        public virtual int ASM_Subject_Upsert(string dB_OperationType, Nullable<System.Guid> guID, string description, string shortDescription, Nullable<System.DateTime> createdOn, Nullable<int> createdBy, Nullable<System.DateTime> updatedOn, Nullable<int> updatedBy, Nullable<int> docType, Nullable<int> documentStatus, Nullable<bool> status, Nullable<int> branchId, Nullable<int> companyId, string remarks, ObjectParameter response)
        {
            var dB_OperationTypeParameter = dB_OperationType != null ?
                new ObjectParameter("DB_OperationType", dB_OperationType) :
                new ObjectParameter("DB_OperationType", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ASM_Subject_Upsert", dB_OperationTypeParameter, guIDParameter, descriptionParameter, shortDescriptionParameter, createdOnParameter, createdByParameter, updatedOnParameter, updatedByParameter, docTypeParameter, documentStatusParameter, statusParameter, branchIdParameter, companyIdParameter, remarksParameter, response);
        }
        ...
        public virtual int BM_Branch_Upsert(string dB_OperationType, Nullable<System.Guid> guID, string description, Nullable<int> campusTypeId, Nullable<int> organizationTypeId, Nullable<int> countryId, Nullable<int> cityId, string address, string contactNo, string emailAddress, string nTNNo, Nullable<System.DateTime> createdOn, Nullable<int> createdBy, Nullable<System.DateTime> updatedOn, Nullable<int> updatedBy, Nullable<int> docType, Nullable<int> documentStatus, Nullable<bool> status, Nullable<int> branchId, Nullable<int> companyId, string remarks, ObjectParameter response)
        {
            var dB_OperationTypeParameter = dB_OperationType != null ?
                new ObjectParameter("DB_OperationType", dB_OperationType) :
                new ObjectParameter("DB_OperationType", typeof(string));
        ...
        public virtual int URM_UserRight_Upsert(string dB_OperationType, Nullable<System.Guid> guID, Nullable<int> userId, Nullable<int> rightId, Nullable<System.DateTime> createdOn, Nullable<int> createdBy, Nullable<System.DateTime> updatedOn, Nullable<int> updatedBy, Nullable<int> docType, Nullable<int> documentStatus, Nullable<bool> status, Nullable<int> branchId, Nullable<int> companyId, string remarks, ObjectParameter response)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("URM_UserRight_Upsert", dB_OperationTypeParameter, guIDParameter, userIdParameter, rightIdParameter, createdOnParameter, createdByParameter, updatedOnParameter, updatedByParameter, docTypeParameter, documentStatusParameter, statusParameter, branchIdParameter, companyIdParameter, remarksParameter, response);
        }
    }
}
